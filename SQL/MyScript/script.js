...
<a href='/logical operators'><li class='LeftSideIndex_Btn' id='logical_operators' name='logical_operators'>SQL Logical Operators</li></a>
...
if (previousitem !== null) {
  a_buttons += `<a href="/SQL/${previousitem}" type="button" onMouseOver="this.style.color='#01e098'"><button class="btn btn-success1"><i class='fas fa-arrow-left'></i> Previous </button></a><br><br><br>`;
}
if (nextitem !== null) {
  a_buttons += `<a href="/SQL/${nextitem}" type="button" onMouseOver="this.style.color='#01e098'"><button class="btn btn-success1">&nbsp;&nbsp;&nbsp; Next <i class='fas fa-arrow-right'></i>&nbsp;&nbsp;&nbsp; </button></a>`;
  }
